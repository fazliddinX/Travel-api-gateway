...
func (h *Handler) CreateItinerary(ctx *gin.Context) {
	...
	if err != nil {
		h.Logger.Error("error in create itineraries", slog.String("error", err.Error()))
		ctx.JSON(http.StatusInternalServerError, models.Errors{
			Message: "error in create itineraries",
		})
		return
	}
...
func (h *Handler) UpdateItinerary(ctx *gin.Context) {
	...
	if err != nil {
		h.Logger.Error("error in update itineraries", slog.String("error", err.Error()))
		ctx.JSON(http.StatusInternalServerError, models.Errors{
			Message: "error in update itineraries",
		})
		return
	}
...
func (h *Handler) DeleteItinerary(ctx *gin.Context) {
	...
	if err != nil {
		h.Logger.Error("error in delete itineraries", "error", err.Error())
		ctx.JSON(http.StatusInternalServerError, models.Errors{
			Message: "error in delete itineraries",
		})
		return
	}
	ctx.JSON(http.StatusOK, resp)
...
func (h *Handler) ListItineraries(ctx *gin.Context) {
	...
	if err != nil {
		h.Logger.Error("Error in get itineraries", "error", err.Error())
		ctx.JSON(http.StatusInternalServerError, models.Errors{
			Message: "Error in get itineraries",
		})
		return
	}
	ctx.JSON(http.StatusOK, resp)
...
func (h *Handler) LeaveComment(ctx *gin.Context) {
	...
	if err != nil {
		h.Logger.Error("Error in add comment to itineraries", "error", err.Error())
		ctx.JSON(http.StatusInternalServerError, models.Errors{
			Message: "Error in add comment to itineraries",
		})
		return
	}
	ctx.JSON(http.StatusOK, resp)
